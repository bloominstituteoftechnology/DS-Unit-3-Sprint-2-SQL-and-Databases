...
- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?
    - One situation where MongoDB is appropriate is if you have unstructured data where you don't have a consistent schema for your data structure. This is very hard to manage properly on a relational database. If, on the other hand you have a rigid data structure, a relational database would be the proper choice.

- What is "NewSQL", and what is it trying to achieve?
    - NewSQL tries to combine the best qualities of an RDBMS and NOSQL. NoSQL databases usually have excellent scaling capabilites but struggles in ACID compliance. NewSQL tries to provide a solution that has both excellent scaling and ACID compliance.
