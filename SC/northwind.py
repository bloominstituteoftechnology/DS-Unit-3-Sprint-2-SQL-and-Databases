...
def part2():
    ...
    c.execute(
        """SELECT (julianday(HireDate) - julianday(BirthDate)) * 0.0027378507871321013 FROM "Employee";""")
    ...
    def meany(fetched):
        N = len(fetched)
        return sum([t[0] for t in fetched]) / N
...
def part3():
    ...
    (Stretch) What are the top five territories (by number of employees), and how many employees do they have?"""
