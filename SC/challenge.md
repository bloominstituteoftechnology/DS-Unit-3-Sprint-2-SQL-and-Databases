...
- What is a situation where a document store (like MongoDB) is appropriate, and
  ...
  - MongoDb is appropriate to store where there is a large amount unstructure data. When you need high avialibilty with the data and use with the cloud. It's not appropriate if you would rather imagine your data as a bunch of interconnected tables.

If you want strong ACID gurantees, you should not use MongoDB.
