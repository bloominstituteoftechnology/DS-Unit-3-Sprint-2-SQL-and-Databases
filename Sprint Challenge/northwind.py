...
print(
    curs.execute('SELECT Id,UnitPrice FROM Product ORDER BY UnitPrice DESC LIMIT 10;').fetchall()
)
#Returns: [(38, 263.5), (29, 123.79), (9, 97), (20, 81), (18, 62.5), (59, 55), (51, 53), (62, 49.3), (43, 46), (28, 45.6)]
