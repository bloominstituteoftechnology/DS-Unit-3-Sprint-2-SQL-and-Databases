...
- In the Northwind database, what is the type of relationship between the
  ...
  The relationship is a many to many because there are no direct connections between the two tables. Both tables can be linked to many other tables, though the EmployeeTerritories table brings them together. Similar to the team and coach example from lecture. 
- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?

  A situation where MongoBD or a document store is appropriate would be a situation where you want to dump data but will not need to cross refence it or compare it to other date. To make an analogy, if you just wanted to store a ton of data about movies, you could use MongoDB. If you wanted to compare what movies Leonardo and Denzel have both appeared in, or what common actors they have, then MongoDB would not be a good place to store your data. 
