...
Answer: The relationship between the 'Employee' and 'Territory' tables is many-to-many.
means that an employee can be assigned to multiple territories and each territory 
can have multiple employees, they are not exclusive to any one employee.

- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?
  
Answer: NoSQL databases like MongoDB have lots of Pros such as being document oriented,
high scalability, more dynamic (no rigid schema), data representation in JSON, just to
name a few. However there are some Cons such as not being as strongly ACID, can have
more complex transactions, no stored procedures. Some situations where it would be
appropriate could be product catalog, content management, Geospatial data like locations,
in situations where data requirements are evolving and changing, or when design changes
are likely to me made. A more traditional SQL system might be better for a highly
transactional system where the schema is designed ahead of time and wont change
often, and when dealing with older systems that are highly connected are built around
a relational data model and SQL.
- What is "NewSQL", and what is it trying to achieve?

Answer: NewSQL is a type of RDBMS that trys to provide the scalability of other 
NoSQL systems while maintaining the ACID guarantees of more traditional relational 
data models. Many financial and order processing systems are too large for most
conventional relational databases and could benefit from the scalability of NoSQL
systems but have transactional requirements that dont work well with NoSQL. Essentially
NewSQL is trying to create a system that can scale like a NoSQL system but is 
strongly ACID like more traditional relational data models. 
