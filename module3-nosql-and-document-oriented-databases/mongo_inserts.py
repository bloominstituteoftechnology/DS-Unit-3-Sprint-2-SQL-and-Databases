...
# app/mongo inserts.py

# client = pymongo.MongoClient("mongodb+srv://jkimbril:<password>@cluster0-kkbm5.mongodb.net/test?retryWrites=true&w=majority")
# db = client.test

# app/mongo_queries.py

load_dotenv() # loads env vars fro the .env file
