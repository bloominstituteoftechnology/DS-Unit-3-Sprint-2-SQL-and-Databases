...
- What is the average age of an employee at the time of their hiring? (Hint: a
  lot of arithmetic works with dates.) **37.22**
...
- What are the ten most expensive items (per unit price) in the database *and*
  their suppliers?
- What is the largest category (by number of unique products in it)? **Confections, 13**
...
Dcoument stores are not good for complex queries but are better for hierarchical data storage. They are better for large data sets. THey are especially good for prototyping databases quickly. They differ from SQL databases in what properties to standardize by (SQL: ACID, NoSQL: CAP).

- What is "NewSQL", and what is it trying to achieve?
NewSQL uses features from both SQL and NoSQL systems and compensates for the weaknesses of both. They hold ACID properties while also providing scalability of NoSQL systems for large datasets, which meets the needs of online transaction scale, speed and availability. 
