...
The relationship between 'Employee' and Territory' is a many to many relationship since an employee can have many territories and a territory can have many employees.
- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?
MongoDB and other databases are great alternatives for unstructured data, or generally speaking adaptability on what can be put away in each assortment. A superb circumstance to utilize a report situated database is for content administration frameworks or informal organizations, or anyplace where the data structures may advance after some time. Archive situated databases are not the best alternative for working with high value-based frameworks (particularly compose serious projects), or for frameworks where the data model is characterized in advance.
- What is "NewSQL", and what is it trying to achieve?
NewSQL is a class of databases that looks to join the ACID agreeable properties of relationship based databases and the adaptability/versatility of NoSQL databases. NewSQL targets online transactional processing (OLTP) outstanding tasks at hand, wherein there is a large volume of both read and write operations that are more appropriate for a conventional SQL database.
