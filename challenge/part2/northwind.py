...
print('10 most expensive items and their prices: ', result2, '\n')
''' ANSWER
...
result2 = curs.fetchall()
print('Average age of employee at time of hiring: ', result2, '\n')
'''
ANSWER 37.2222222
 '''
...
LIMIT 10;""")
result2 = curs.fetchall()
print('10 most expensive items and their suppliers: ', result2, '\n')
''' ANSWER
...
LIMIT 1;""")
result2 = curs.fetchall()
print('Largest category by number of unique products: ', result2, '\n')
'''
