"""
My original strategy was to convert use pandas and sqlalchemy to convert
the 'titanic.csv' to an sqlite3 file which I would use to enter into 
My elephantSQL database, however the name column gave me way too many problems.
So I ended up just using DMA's suggested use of SQLizer to
convert the csv file to correct SQL statements.
"""
...
create_titanic_table = """CREATE TABLE IF NOT EXISTS "titanic" (
    "Survived" INT,
    "Pclass" INT,
    "Name" TEXT,
    "Sex" TEXT,
...
def main():
	...
	"""
	pg_cur.execute(insert_into_titanic)
