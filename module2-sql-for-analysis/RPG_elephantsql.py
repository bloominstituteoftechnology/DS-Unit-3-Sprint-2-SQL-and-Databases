...
sl_curs.execute('SELECT COUNT(*) FROM charactercreator_mage').fetchall()

mages = sl_curs.execute('SELECT * FROM charactercreator_mage;').fetchall()

sl_curs.execute('PRAGMA table_info(charactercreator_mage);').fetchall()
...
sl_curs.execute('SELECT COUNT(*) FROM charactercreator_thief').fetchall()

thieves = sl_curs.execute('SELECT * FROM charactercreator_thief').fetchall()

sl_curs.execute('PRAGMA table_info(charactercreator_thief);').fetchall()
...
sl_curs.execute('SELECT COUNT(*) FROM charactercreator_cleric').fetchall()

clerics = sl_curs.execute('SELECT * FROM charactercreator_cleric').fetchall()

sl_curs.execute('PRAGMA table_info(charactercreator_cleric);').fetchall()
...
sl_curs.execute('SELECT COUNT(*) FROM charactercreator_fighter').fetchall()

fighters = sl_curs.execute('SELECT * FROM charactercreator_fighter').fetchall()

sl_curs.execute('PRAGMA table_info(charactercreator_fighter);').fetchall()
...
sl_curs.execute('SELECT COUNT(*) FROM charactercreator_necromancer').fetchall()

nmcs = sl_curs.execute('SELECT * FROM charactercreator_necromancer').fetchall()

sl_curs.execute('PRAGMA table_info(charactercreator_necromancer);').fetchall()
