...
print([('Kirkland', 29.0), ('London', 32.5), ('Redmond', 56.0), ('Seattle', 40.0), ('Tacoma', 40.0)])
...
query = """SELECT Product.ProductName, CategoryName, Category.Id
FROM PRODUCT 
...
query = """SELECT Employee.FirstName, EmployeeTerritory.TerritoryId
FROM Employee
JOIN EmployeeTerritory on EmployeeTerritory.EmployeeId=Employee.Id"""
curs.execute(query).fetchall()
