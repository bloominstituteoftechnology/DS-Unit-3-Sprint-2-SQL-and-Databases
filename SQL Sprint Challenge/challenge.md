...
- What is a situation where a document store (like MongoDB) is appropriate, and
  ...
  Best uses for document stores like Mongo db or other NO-SQL databases are for quickly changing data or  large amounts of data. By not adhering to a set sturcture of input it allows the flow of data to be stored quickly and efficiently. I believe a poor use of this structure would be where a database has smallier amount of data incoming at any given time.
