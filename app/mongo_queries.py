# mongodb+srv://user123:<password>@ds13inclass-eakol.mongodb.net/test?retryWrites=true&w=majority
...
# connection_uri = "mongodb+srv://user123:sesame24@ds13inclass-eakol.mongodb.net/test?retryWrites=true&w=majority"
print("----------------")
...
team = [warturtle, jigglypuff, charizard, swampert, snorlax]
