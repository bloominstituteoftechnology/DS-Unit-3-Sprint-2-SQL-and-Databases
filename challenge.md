...
The relationship is a one-to-many relationship. Employees have more than one 
territory, but territories do not have more than one employee.

- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?

A document store like MongoDB can be good when you store documents that may not
make sense to exist in a traditional relational database. This might make sense
if you do not need 100% of the data readily accessible but simply want the 
documnets themselves to be available.

- What is "NewSQL", and what is it trying to achieve?

NewSQL tries to improve scalability while also maintaining ACID guarantees. 
This is useful for online transcation processing because it allows one to
have large amounts of transactions but still have a guarantee that the 
data will be valid in case of power failures, errors, etc.
