...
- In the Northwind database, what is the type of relationship between the
  ...
  Many to many relationship. There can be multiple employees and multiple territories. 
- What is a situation where a document store (like MongoDB) is appropriate, and
  what is a situation where it is not appropriate?
It is useful where its pros (document oriented, high performance, high availability and scalability) are needed, such as e-commerce catalogs, blogs, and real-time analytics. It is not useful for highly transactional systems or where the data model is designed up front. One instance where it failed was in the creation of Diaspora, a distributed social network. 
